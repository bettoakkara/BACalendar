...
func GetWeekByLang(weekDay: Int, language: CalendarLanguage = .english) -> String
{
    switch language {
    case .english:
        return weekArr_En_Sh[weekDay]!
    }
}

func GetHumanDate(month: Int, language: CalendarLanguage = .english) -> String
{
    switch language {
    case .english:
        return monthArr_En_Sh[month]!
    }
}
